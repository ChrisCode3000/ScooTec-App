...
def query():
	...
	query_label = Label(db_root, text=print_records)
...
# Create Text Boxes
f_name = Entry(db_root, width=30)
f_name.grid(row=0, column=1, padx=20, pady=(10, 0))
l_name = Entry(db_root, width=30)
l_name.grid(row=1, column=1)
address = Entry(db_root, width=30)
address.grid(row=2, column=1)
city = Entry(db_root, width=30)
city.grid(row=3, column=1)
state = Entry(db_root, width=30)
state.grid(row=4, column=1)
zipcode = Entry(db_root, width=30)
zipcode.grid(row=5, column=1)
delete_box = Entry(db_root, width=30)
delete_box.grid(row=9, column=1, pady=5)


# Create Text Box Labels
f_name_label = Label(db_root, text="First Name")
f_name_label.grid(row=0, column=0, pady=(10, 0))
l_name_label = Label(db_root, text="Last Name")
l_name_label.grid(row=1, column=0)
address_label = Label(db_root, text="Address")
address_label.grid(row=2, column=0)
city_label = Label(db_root, text="City")
city_label.grid(row=3, column=0)
state_label = Label(db_root, text="State")
state_label.grid(row=4, column=0)
zipcode_label = Label(db_root, text="Zipcode")
zipcode_label.grid(row=5, column=0)
delete_box_label = Label(db_root, text="Select ID")
